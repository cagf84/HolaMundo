...
public class EjerciciosVariablesMod8v2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //8.v2
        string varPi0 = (string)varCastNumeroPI.ToString();
        string[] varPi1 = varPi0.Split(",");
        string varPiEntero;
        string varPidecimal;
        varPiEntero = varPi1[0];
        varPidecimal = varPi1[1];
        int intIndicePIDecimal = 0;
        int intIndicePIDecimalFinal = 4;
        string varPidecimalCorto = varPidecimal.Substring(intIndicePIDecimal, intIndicePIDecimalFinal);
        Debug.Log("El valor entero es: " + varPiEntero);
        Debug.Log("El valor decimal (4num) es: " + varPidecimalCorto);
        ...
        strNombre = varNombreCompleto.Substring(intIndiceNombre, intIndiceNombreTotal);        
        strApellido1 = varNombreCompleto.Substring(intIndiceAP1, intIndiceAP1Total);        
        strApellido2 = varNombreCompleto.Substring(intIndiceAP2, intIndiceAP2Total);
        Debug.Log(strNombre);
        Debug.Log(strApellido1);
        Debug.Log(strApellido2);
        ...
        Debug.Log($"La edad de una persona nacida el {varAno1}, al {varAno2} es: {varCastAno2 - varCastAno1}");
    ...
    void CuentaPalabras()
    {
        ...
        varPalabrasPar = varPalabrasPar.Remove(varPalabrasPar.Length - 1);
    }
